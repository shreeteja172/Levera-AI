...
-- CreateIndex
CREATE UNIQUE INDEX "SolveHistory_userId_problemId_key" ON "SolveHistory"("userId", "problemId");
...
-- AddForeignKey
ALTER TABLE "SolveHistory" ADD CONSTRAINT "SolveHistory_problemId_fkey" FOREIGN KEY ("problemId") REFERENCES "Problem"("id") ON DELETE CASCADE ON UPDATE CASCADE;
