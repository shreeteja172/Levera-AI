...
export function SolutionCard({
  ...
  return (
    ...
    >
      ...
      <div className="border-t border-zinc-900 flex-1 flex flex-col min-h-[24rem]">
        <div className="flex bg-zinc-950 border-b border-zinc-900 p-1 select-none">
          <button
        ...
        <div className="flex-1 p-5 flex flex-col bg-zinc-900/40 min-h-[22rem] max-h-[35rem] overflow-y-auto custom-scrollbar [scrollbar-width:thin] [scrollbar-color:rgba(255,255,255,0.05)_transparent]">
          {activeTab === "code" ? (
            ...
            <div className="flex-grow flex flex-col gap-6 text-sm">
              ...
              {mentorNotes.trim() ? (
                ...
                <div className="mt-4 p-4 border border-zinc-800 bg-zinc-950/20 rounded-xl space-y-2">
